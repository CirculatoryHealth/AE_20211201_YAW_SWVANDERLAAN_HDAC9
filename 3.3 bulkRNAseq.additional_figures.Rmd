...
## HDAC9 vs. cytokines plaque levels `lm()`
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.PlaqueVulnerabilityIndex.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.PlaqueVulnerabilityIndex.BarPlot.median_iqr.pdf"), plot = last_plot())
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.PlaqueVulnerabilityIndex.BarPlot.means_se.pdf"), plot = last_plot())
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.PlaqueVulnerabilityIndex.Boxplot.outlier_above_100_removed.pdf"), plot = last_plot())
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.PlaqueVulnerabilityIndex.byGender.pdf"), plot = last_plot())
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.PlaqueVulnerabilityIndex_Facet_byYear.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.PlaqueVulnerabilityIndex_Facet_byYear.byGender.pdf"), plot = last_plot())
...
Analysis of the plaque vulnerability indez as a function of plaque `r TRAIT_OF_INTEREST` levels.
...
## Plotting HDAC9 vs Fat 10% in the plaque
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Fat.bin_10.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Fat.bin_10.byGender.pdf"), plot = last_plot())
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Fat.bin_10_Facet_byYear.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Fat.bin_10_Facet_byYear.byGender.pdf"), plot = last_plot())
```

## Plotting HDAC9 vs Fat 40% in the plaque
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Fat.bin_40.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Fat.bin_40.byGender.pdf"), plot = last_plot())
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Fat.bin_40_Facet_byYear.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Fat.bin_40_Facet_byYear.byGender.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.IPH.bin.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.IPH.bin.byGender.pdf"), plot = last_plot())
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.IPH.bin_Facet_byYear.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.IPH.bin_Facet_byYear.byGender.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Calc.bin.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Calc.bin.byGender.pdf"), plot = last_plot())
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Calc.bin_Facet_byYear.pdf"), plot = last_plot())
```
...
ggsave(filename = paste0(PLOT_loc, "/", Today, ".",TRAIT_OF_INTEREST,".plaque.exp2_pgmL.Calc.bin_Facet_byYear.byGender.pdf"), plot = last_plot())
```
